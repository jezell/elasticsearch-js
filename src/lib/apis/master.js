...
/**
 * Perform a [coordinate search](http://www.elastic.co/guide/en/elasticsearch/reference/master/search-search.html) (SIREN-join) request
 *
 * @param {Object} params - An object with parameters used to carry out this action
 * @param {String} params.analyzer - The analyzer to use for the query string
 * @param {Boolean} params.analyzeWildcard - Specify whether wildcard and prefix queries should be analyzed (default: false)
...
api.coordinateSearch = ca({
  ...
  urls: [
    {
      fmt: '/<%=index%>/<%=type%>/_coordinate_search',
      req: {
        index: {
          type: 'list'
        },
